...
class GAN(object):
    ...
    def __init__(self, imgRows = 28, imgCols = 28, channel = 1):
    ...
    def discriminator(self):
        ...
        input_shape = (self.imgRows, self.imgCols, self.channel)
    ...
    def generator(self):
        ...
        dropout = 0.4
        depth = 64*4 
        dim = int(28/4) #Dépend de la taille des images
...
if __name__ == '__main__':
    ...
    digitGan = digitGAN()
    #timer = ElapsedTimer()
    digitGan.train(trainSteps=10000, batchSize=256, saveInterval=100) #100000 steps normalement et 500 interval
    #timer.elapsed_time()
    digitGan.plotImgs(fake=True)
    digitGan.plotImgs(fake=False, save2file=True)
